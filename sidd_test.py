...
parser.add_argument('--input_dir', default='/home/jiangmao/code/dataset/test', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='/home/jiangmao/code/NSNet/one_128/results/SIDD/', type=str, help='Directory for results')
...
# save denoised data
sio.savemat(os.path.join(result_dir, 'SubmitSrgb.mat'), {"Idenoised": restored,})